...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: homeProvider.isNotification ? const SkeletonList() :    homeProvider.notificationModel.notificationData!.isEmpty ? const Column(
        mainAxisAlignment: MainAxisAlignment.center,
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Center(child: Text("No new notifications")),
          Center(child: Text("Looks like you haven't received any notification")),
        ],
      ) : ListView.separated(
