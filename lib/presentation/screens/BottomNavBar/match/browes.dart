...
import 'package:afrilove_world/data/models/favoritelistmodel.dart';
import 'package:afrilove_world/data/models/newmatchmodel.dart';
import 'package:afrilove_world/data/models/passedmodel.dart';
...
import 'package:afrilove_world/presentation/screens/other/likeMatch/like_match.dart';
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (c, i) {
                                return InkWell(
                                  onTap: () {
                                    errorloader == true ? Fluttertoast.showToast(msg: "Please wait") : matchProvider.updateIndex(i);
                                  },
                                  child: Container(
            ...
            child: InkWell(
              onTap: () {
                ...
                Provider.of<DetailProvider>(context, listen: false)
                    .status = "3";
                Provider.of<DetailProvider>(context, listen: false)
                    .detailsApi(uid: Provider.of<HomeProvider>(context, listen: false).uid ?? "",
                    lat: lat.toString(),
                    long: long.toString(),
                    profileId: data.profileId ?? '')
                    .then((value) {
